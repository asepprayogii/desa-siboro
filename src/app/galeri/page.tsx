    ...
    <main className="bg-white py-20">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-14">
          <span className="inline-block bg-blue-50 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full mb-3">Dokumentasi</span>
        ...
        {galeri && galeri.length > 0 ? <GaleriGrid items={galeri} /> : <p className="text-gray-400 text-center py-20">Belum ada foto galeri.</p>}
      </div>
    </main>
  );
}
