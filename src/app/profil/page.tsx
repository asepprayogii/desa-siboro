  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 whitespace-pre-line">{profil?.sejarah || "Belum ada data."}</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-2">Visi</h2>
        <p className="text-gray-700 whitespace-pre-line">{profil?.visi || "Belum ada data."}</p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-2">Misi</h2>
        <p className="text-gray-700 whitespace-pre-line">{profil?.misi || "Belum ada data."}</p>
      </section>

      <section>
        <h2 className="text-xl font-semibold mb-2">Deskripsi Umum</h2>
        <p className="text-gray-700 whitespace-pre-line">{profil?.deskripsi || "Belum ada data."}</p>
      </section>
    </main>
  );
}
