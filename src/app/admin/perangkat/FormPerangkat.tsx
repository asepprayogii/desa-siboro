  ...
  return (
    <form onSubmit={handleSubmit} className="border rounded-lg p-4 space-y-3">
      ...
      <div>
        ...
        {isEdit && initialData?.foto_url && !file && (
          <p className="text-xs text-gray-500 mt-1">Foto saat ini sudah ada. Pilih file baru untuk mengganti.</p>
        )}
      </div>
      ...
      <button
        ...
        className="bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium disabled:opacity-50"
      >
